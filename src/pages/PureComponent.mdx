...
```tsx
export class ChildPureComponentWithObjectProps extends Component<TObjectProps> {
  render() {
...
```tsx
export class ChildPureComponentWithObjectProps extends Component<{
  str: string;
}> {
...
```tsx
export class ChildPureComponentWithObjectPropsMemoized extends Component<
  TObjectProps
> {
